...
@section('main-content')
                                        ...
                                        @foreach ($galeri as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="my-3 p-1 rounded text-white {{ $item->type == 'galeri' ? 'bg-warning' : 'bg-success' }}">{{ $item->type }}
                                                    </span>
                                                </td>
                                                <td>
                                                    {{ $item->description }}
                                                ...
                                                <td width="200">
                                                    ...
                                                    @include('admin.galeri.components.modal_edit')
                                                ...
                                                @include('admin.galeri.components.modal_delete')
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    @include('admin.galeri.components.modal_create')
@endsection
