...
@section('main-content')
                                        ...
                                        @foreach ($Team as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="my-3 p-1 rounded text-white {{ $item->position == 'Owner' ? 'bg-success' : 'bg-warning' }}">{{ $item->position }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <span><i class="fa fa-phone"></i> {{ $item->phone }}</span><br>
                                                ...
                                                <td width="200">
                                                    ...
                                                    @include('admin.team.components.modal_edit')
                                                ...
                                                @include('admin.team.components.modal_delete')
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    @include('admin.team.components.modal_create')
@endsection
