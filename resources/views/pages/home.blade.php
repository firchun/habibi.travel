...
@section('content')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                            <ul class="list-marked-2 box-categories-list">
                                <li><a href="#"><img src="{{ asset('frontend_theme') }}/images/cta-1-368x420.jpg"
                        ...
                        <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                            <ul class="list-marked-2 box-categories-list">
                                <li><a href="#"><img src="{{ asset('frontend_theme') }}/images/cta-2-368x420.jpg"
                                            alt="" width="368" height="420" /></a>
                        ...
                        <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                            <ul class="list-marked-2 box-categories-list">
                                <li><a href="#"><img src="{{ asset('frontend_theme') }}/images/cta-3-368x420.jpg"
                                            alt="" width="368" height="420" /></a>
        ...
        <div class="container">
            <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
                <div class="col-lg-6 text-center wow fadeInUp"><img
                        src="{{ asset('frontend_theme') }}/images/index-3-556x382.jpg" alt="" width="556"
                        height="382" />
                </div>
            ...
            <div class="row row-sm row-40 row-md-50">
                    ...
                    <article class="product-big">
                        <div class="unit flex-column flex-md-row align-items-md-stretch">
                            <div class="unit-left"><a class="product-big-figure" href="#"><img
                                        src="{{ asset('frontend_theme') }}/images/product-big-1-600x366.jpg"
                            ...
                            <div class="unit-body">
                                <div class="product-big-body">
                                    ...
                                    <p class="product-big-text">Benidorm is a buzzing resort with a big reputation for
                                        beach holidays. Situated in sunny Costa Blanca, the town is one of the original
                                        Spanish beach resorts...</p><a class="button button-black-outline button-ujarak"
                ...
                <div class="col-sm-6 col-md-12 wow fadeInLeft">
                    ...
                    <article class="product-big">
                        <div class="unit flex-column flex-md-row align-items-md-stretch">
                            <div class="unit-left"><a class="product-big-figure" href="#"><img
                                        src="{{ asset('frontend_theme') }}/images/product-big-2-600x366.jpg"
                                        alt="" width="600" height="366" /></a></div>
                            <div class="unit-body">
                                <div class="product-big-body">
                                    ...
                                    <p class="product-big-text">The beautiful and inviting island nation of Mauritius is an
                                        ideal ‘flop and drop’ at the conclusion of your safari. Indulge in the delightful
                                        scents of the fragrant...</p><a class="button button-black-outline button-ujarak"
                                        href="#">Buy This Tour</a>
        ...
        <div class="container">
            ...
            <div class="row row-30 justify-content-center box-ordered">
                <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <article class="team-modern">
                        <div class="team-modern-header"><a class="team-modern-figure" href="#"><img
                                    class="img-circles" src="{{ asset('frontend_theme') }}/images/user-1-118x118.jpg"
                                    alt="" width="118" height="118" /></a>
                ...
                <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <article class="team-modern">
                        <div class="team-modern-header"><a class="team-modern-figure" href="#"><img
                                    class="img-circles" src="{{ asset('frontend_theme') }}/images/user-2-118x118.jpg"
                                    alt="" width="118" height="118" /></a>
                            <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70"
                                enable-background="new 0 0 270 70" xml:space="preserve">
                                <g>
                ...
                <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <article class="team-modern">
                        <div class="team-modern-header"><a class="team-modern-figure" href="#"><img
                                    class="img-circles" src="{{ asset('frontend_theme') }}/images/user-3-118x118.jpg"
                                    alt="" width="118" height="118" /></a>
                            <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70"
                                enable-background="new 0 0 270 70" xml:space="preserve">
                                <g>
                ...
                <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <article class="team-modern">
                        <div class="team-modern-header"><a class="team-modern-figure" href="#"><img
                                    class="img-circles" src="{{ asset('frontend_theme') }}/images/user-4-118x118.jpg"
                                    alt="" width="118" height="118" /></a>
                            <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70"
                                enable-background="new 0 0 270 70" xml:space="preserve">
                                <g>
    ...
    <section class="section bg-default text-center offset-top-50">
        <div class="parallax-container" data-parallax-img="{{ asset('frontend_theme') }}/images/parallax-1-1920x850.jpg">
    ...
    <section class="section section-sm section-top-0 section-fluid section-relative bg-gray-4">
        <div class="container-fluid">
            ...
            <div class="owl-carousel owl-classic owl-dots-secondary" data-items="1" data-sm-items="2" data-md-items="3"
                data-lg-items="4" data-xl-items="5" data-xxl-items="6" data-stage-padding="15"
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-1-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-1-1200x800-original.jpg"
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-2-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-2-1200x800-original.jpg"
                            data-lightgallery="item"><img
                                src="{{ asset('frontend_theme') }}/images/gallery-image-2-270x195.jpg" alt=""
                                width="270" height="195" /></a>
                    </div>
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-3-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-3-1200x800-original.jpg"
                            data-lightgallery="item"><img
                                src="{{ asset('frontend_theme') }}/images/gallery-image-3-270x195.jpg" alt=""
                                width="270" height="195" /></a>
                    </div>
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-4-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-4-1200x800-original.jpg"
                            data-lightgallery="item"><img
                                src="{{ asset('frontend_theme') }}/images/gallery-image-4-270x195.jpg" alt=""
                                width="270" height="195" /></a>
                    </div>
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-5-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-5-1200x800-original.jpg"
                            data-lightgallery="item"><img
                                src="{{ asset('frontend_theme') }}/images/gallery-image-5-270x195.jpg" alt=""
                                width="270" height="195" /></a>
                    </div>
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-6-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-6-1200x800-original.jpg"
                            data-lightgallery="item"><img
                                src="{{ asset('frontend_theme') }}/images/gallery-image-6-270x195.jpg" alt=""
                                width="270" height="195" /></a>
                    </div>
                ...
                <article class="thumbnail thumbnail-mary">
                    <div class="thumbnail-mary-figure"><img
                            src="{{ asset('frontend_theme') }}/images/gallery-image-7-270x195.jpg" alt=""
                            width="270" height="195" />
                    </div>
                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                            href="{{ asset('frontend_theme') }}/images/gallery-image-7-1200x800-original.jpg"
                            data-lightgallery="item"><img
                                src="{{ asset('frontend_theme') }}/images/gallery-image-7-270x195.jpg" alt=""
                                width="270" height="195" /></a>
                    </div>
