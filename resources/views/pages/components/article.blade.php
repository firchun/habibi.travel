<section class="section section-sm bg-default">
                        ...
                        <div class="unit flex-column flex-md-row align-items-md-stretch">
                            ...
                            <div class="unit-body">
                                <div class="product-big-body">
                                    ...
                                    <p class="product-big-text">{!! Str::limit($article_item->description, 150) !!}</p><a
    ...
    <a class="button button-black-outline button-ujarak" href="{{ route('hot_article') }}">All Article</a>
</section>
