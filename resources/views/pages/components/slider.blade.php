 ...
 <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2"
     ...
     <div class="swiper-wrapper text-left">
         <div class="swiper-slide context-dark"
             data-slide-bg="{{ asset('frontend_theme') }}/images/slider-4-slide-1-1920x678.jpg">
                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col-md-10">
                             ...
                             </h2><a class="button button-default-outline button-ujarak" href="#"
         ...
         <div class="swiper-slide context-dark"
             data-slide-bg="{{ asset('frontend_theme') }}/images/slider-4-slide-2-1920x678.jpg">
             <div class="swiper-slide-caption section-md">
                 <div class="container">
                     <div class="row">
                         <div class="col-md-10">
         ...
         <div class="swiper-slide context-dark"
             data-slide-bg="{{ asset('frontend_theme') }}/images/slider-4-slide-3-1920x678.jpg">
             <div class="swiper-slide-caption section-md">
                 <div class="container">
                     <div class="row">
                         <div class="col-md-10">
